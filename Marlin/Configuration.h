...
#define STRING_CONFIG_H_AUTHOR "(Veniero, Megan Config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Megan"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 69.4
  #define DEFAULT_bedKi 13.72
  #define DEFAULT_bedKd 233.7
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.090 // (mm) Distance from real junction edge
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.05  // (mm) Comment out to use the last-measured height
#endif
